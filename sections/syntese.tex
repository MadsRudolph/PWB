...
Tester alle ti ALU-operationer gennem hele signalkæden: \texttt{Instruction\_In} $\rightarrow$ IR $\rightarrow$ IDC $\rightarrow$ kontrolsignaler. For hver instruktion verificeres at FS, RW, DX og AX er korrekte, at \texttt{Constant\_Out} matcher Zero Fillerens output, og at \texttt{Address\_Out} (PC) inkrementeres efter hver instruktion.

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{images/syntese/mpc_tb_group1.png}
    \caption{Simulering af MPC Gruppe 1: ALU register-register. Address\_Out inkrementeres fra 00 til 0A gennem ti instruktioner.}
    \label{fig:mpc-tb-g1}
\end{figure}
