...
\begin{itemize}
    \item \textbf{Gruppe 1 -- Register-register:} Alle ti register-register operationer (MOVA, INC, ADD, SUB, DEC, OR, AND, XOR, NOT, MOVB). For hver instruktion verificeres FS, RW, DX, AX, MB samt at PC inkrementeres korrekt. Desuden verificeres \texttt{Constant\_Out} fra Zero Filleren.
